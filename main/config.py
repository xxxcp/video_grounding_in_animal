...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--eval_split_name", type=str, default="val",
                            help="should match keys in video_duration_idx_path, must set for VCMR   relevant_windows")
        ...
        parser.add_argument("--lr_drop", type=int, default=200, help="drop learning rate to 1/10 every lr_drop epochs")
        parser.add_argument("--lr_gamma", type=float, default=0.1, help="lr reduces the gamma times after the `drop' epoch")
        parser.add_argument("--lr_warmup", type=float, default=10, help="linear warmup scheme")
        ...
        parser.add_argument("--s_loss_inter_coef", type=float, default=0.1, help="intra-video (sample-level) saliency loss,")

        # * Eval configs
        parser.add_argument("--main_metric", type=str, default="MR-full-mIoU-key") #MR-full-mAP MR-full-mIoU-key MR-full-R1@0.3-key
        ...
        parser.add_argument("--resume", type=str, default="/mnt/evo1/XCP/UniVTG-main/results/2/model_best.ckpt",#"results/mr-charades/test-clip-clip-2024_03_12_23/model_best.ckpt",#"/mnt/evo1/XCP/UniVTG-main/results/2/model_best.ckpt",
        ...
        parser.add_argument("--max_before_nms", type=int, default=1000) #1000
        parser.add_argument("--max_after_nms", type=int, default=10)
        parser.add_argument("--conf_thd", type=float, default=0, help="only keep windows with conf >= conf_thd")
        ...
        parser.add_argument("--v_feat_dirs", default="/mnt/evo1/XCP/UniVTG-main/data/animal_kingdom/vid_clip", type=str, nargs="+",
                            help="video feature dirs. If more than one, will concat their features. "
                                 "Note that sub ctx features are also accepted here.")
        parser.add_argument("--t_feat_dir", default="/mnt/evo1/XCP/UniVTG-main/data/animal_kingdom/txt_clip", type=str, help="text/query feature dir")
        ...
        parser.add_argument("--v_feat_types",  default="clip",type=str)
        parser.add_argument("--t_feat_type",  default="clip",type=str)
